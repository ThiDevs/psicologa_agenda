    ...
    : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ClinicalDraft>(entity =>
        {
            ...
            entity.Property(draft => draft.SessionNote).HasColumnName("session_note").HasColumnType("text");
            entity.Property(draft => draft.ContentText).HasColumnName("content_text").HasColumnType("text").IsRequired();
        ...
        modelBuilder.Entity<AppliedClinicalTag>(entity =>
        {
            ...
            entity.Property(tag => tag.Note).HasColumnName("note").HasColumnType("text");
        ...
        modelBuilder.Entity<ClinicalRecord>(entity =>
        {
            ...
            entity.Property(record => record.ContentText).HasColumnName("content_text").HasColumnType("text").IsRequired();
        ...
        modelBuilder.Entity<ClinicalAlert>(entity =>
        {
            ...
            entity.Property(alert => alert.Title).HasColumnName("title").HasColumnType("text").IsRequired();
            entity.Property(alert => alert.Description).HasColumnName("description").HasColumnType("text").IsRequired();
            ...
            entity.Property(alert => alert.ReviewNote).HasColumnName("review_note").HasColumnType("text");
        ...
        modelBuilder.Entity<TreatmentPlan>(entity =>
        {
            ...
            entity.Property(plan => plan.CaseFormulation).HasColumnName("case_formulation").HasColumnType("text");
        ...
        modelBuilder.Entity<PatientTask>(entity =>
        {
            ...
            entity.Property(task => task.Description).HasColumnName("description").HasColumnType("text");
            ...
            entity.Property(task => task.ResponseText).HasColumnName("response_text").HasColumnType("text");
        ...
        modelBuilder.Entity<SharedMaterial>(entity =>
        {
            ...
            entity.Property(material => material.Title).HasColumnName("title").HasColumnType("text").IsRequired();
            entity.Property(material => material.Description).HasColumnName("description").HasColumnType("text");
        ...
        modelBuilder.Entity<PatientCheckIn>(entity =>
        {
            ...
            entity.Property(checkIn => checkIn.Prompt).HasColumnName("prompt").HasColumnType("text").IsRequired();
            entity.Property(checkIn => checkIn.ContextNote).HasColumnName("context_note").HasColumnType("text");
            ...
            entity.Property(checkIn => checkIn.ResponseText).HasColumnName("response_text").HasColumnType("text");
