...
{
    private readonly string _issuer = configuration["Jwt:Issuer"] ?? "nails-agenda-api";
    private readonly string _audience = configuration["Jwt:Audience"] ?? "nails-agenda-app";
