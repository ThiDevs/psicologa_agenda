...
- Confirmar que `https://api.felicio.app/api/health` responde `200`.
...
- Apos o deploy do backend, confirmar as URLs web publicas:
  - Frontend/marketing: `https://psi.felicio.app`
  - Privacidade: `https://api.felicio.app/privacy`
  - Termos: `https://api.felicio.app/terms`
  - Suporte: `https://api.felicio.app/support`
...
- Privacy Policy URL configurada no App Store Connect: `https://api.felicio.app/privacy`.
- Support URL configurada na versao iOS 1.0: `https://api.felicio.app/support`.
- Terms URL publica disponivel em `https://api.felicio.app/terms`.
